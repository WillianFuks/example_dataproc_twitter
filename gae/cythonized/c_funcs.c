...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [], 
        "name": "gae.cythonized.c_funcs", 
        "sources": [
            "c_funcs.pyx"
        ]
    }, 
    "module_name": "gae.cythonized.c_funcs"
}
END: Cython Metadata */
...
#define __PYX_HAVE__gae__cythonized__c_funcs
#define __PYX_HAVE_API__gae__cythonized__c_funcs
#include <string.h>
#include <stdio.h>
#include "pythread.h"
#ifdef _OPENMP
...
/*--- Type declarations ---*/
struct __pyx_opt_args_3gae_10cythonized_7c_funcs_cy_aggregate_scores;
...
/* Module declarations from 'gae.cythonized.c_funcs' */
static PyObject *__pyx_f_3gae_10cythonized_7c_funcs_cy_aggregate_scores(PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_3gae_10cythonized_7c_funcs_cy_aggregate_scores *__pyx_optional_args); /*proto*/
#define __Pyx_MODULE_NAME "gae.cythonized.c_funcs"
extern int __pyx_module_is_main_gae__cythonized__c_funcs;
int __pyx_module_is_main_gae__cythonized__c_funcs = 0;

/* Implementation of 'gae.cythonized.c_funcs' */
...
static PyObject *__pyx_f_3gae_10cythonized_7c_funcs_cy_aggregate_scores(PyObject *__pyx_v_inters, PyObject *__pyx_v_weights, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_3gae_10cythonized_7c_funcs_cy_aggregate_scores *__pyx_optional_args) {
  ...
  PyObject *__pyx_v_inters_i = NULL;
  ...
  __Pyx_RefNannySetupContext("cy_aggregate_scores", 0);
  if (__pyx_optional_args) {
  }

  /* "gae/cythonized/c_funcs.pyx":9
 *     cdef int j
 *     cdef double weight
 *     res = {}             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_t_4 = PyObject_GetItem(__pyx_v_inters_i, __pyx_n_s_scores); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_XDECREF_SET(__pyx_v_scores, __pyx_t_4);
    __pyx_t_4 = 0;
 ...
 *             sku = items[j]
 */
    __pyx_t_4 = PyObject_GetItem(__pyx_v_inters_i, __pyx_n_s_items); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_XDECREF_SET(__pyx_v_items, __pyx_t_4);
    __pyx_t_4 = 0;

    /* "gae/cythonized/c_funcs.pyx":15
 *         scores = inters_i['scores']
 *         items = inters_i['items']
 *         for j in range(len(items)):             # <<<<<<<<<<<<<<
 *             sku = items[j]
 ...
 */
    __pyx_t_6 = PyObject_Length(__pyx_v_items); if (unlikely(__pyx_t_6 == ((Py_ssize_t)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_j = __pyx_t_7;

      /* "gae/cythonized/c_funcs.pyx":16
 *         items = inters_i['items']
 *         for j in range(len(items)):
 *             sku = items[j]             # <<<<<<<<<<<<<<
 *             res.setdefault(sku, 0.0)
 ...
 */
      __pyx_t_4 = __Pyx_GetItemInt(__pyx_v_items, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 16, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_XDECREF_SET(__pyx_v_sku, __pyx_t_4);
      __pyx_t_4 = 0;

      /* "gae/cythonized/c_funcs.pyx":17
 *         for j in range(len(items)):
 *             sku = items[j]
 *             res.setdefault(sku, 0.0)             # <<<<<<<<<<<<<<
 *             res[sku] += weight * scores[j]
 *     return  res.items()
 */
      __pyx_t_4 = __Pyx_PyDict_SetDefault(__pyx_v_res, __pyx_v_sku, __pyx_float_0_0, -1L); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 17, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

      /* "gae/cythonized/c_funcs.pyx":18
 *             sku = items[j]
 *             res.setdefault(sku, 0.0)
 *             res[sku] += weight * scores[j]             # <<<<<<<<<<<<<<
 *     return  res.items()
 */
      __Pyx_INCREF(__pyx_v_sku);
      __pyx_t_4 = __pyx_v_sku;
      __pyx_t_1 = __Pyx_PyDict_GetItem(__pyx_v_res, __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_8 = PyFloat_FromDouble(__pyx_v_weight); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_9 = __Pyx_GetItemInt(__pyx_v_scores, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = PyNumber_Multiply(__pyx_t_8, __pyx_t_9); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = PyNumber_InPlaceAdd(__pyx_t_1, __pyx_t_10); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      if (unlikely(PyDict_SetItem(__pyx_v_res, __pyx_t_4, __pyx_t_9) < 0)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    }
  }

  /* "gae/cythonized/c_funcs.pyx":19
 *             res.setdefault(sku, 0.0)
 *             res[sku] += weight * scores[j]
 *     return  res.items()             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __Pyx_PyDict_Items(__pyx_v_res); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_r = __pyx_t_4;
  __pyx_t_4 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("gae.cythonized.c_funcs.cy_aggregate_scores", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_res);
  __Pyx_XDECREF(__pyx_v_inters_i);
...
static PyObject *__pyx_pw_3gae_10cythonized_7c_funcs_1cy_aggregate_scores(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("cy_aggregate_scores (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_aggregate_scores") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("cy_aggregate_scores", 0, 2, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gae.cythonized.c_funcs.cy_aggregate_scores", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_3gae_10cythonized_7c_funcs_cy_aggregate_scores(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_inters, PyObject *__pyx_v_weights, int __pyx_v_n) {
  ...
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_3gae_10cythonized_7c_funcs_cy_aggregate_scores __pyx_t_2;
  __Pyx_RefNannySetupContext("cy_aggregate_scores", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 1;
...
static PyMethodDef __pyx_methods[] = {
  {"cy_aggregate_scores", (PyCFunction)__pyx_pw_3gae_10cythonized_7c_funcs_1cy_aggregate_scores, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_c_funcs(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_c_funcs},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initc_funcs(void); /*proto*/
PyMODINIT_FUNC initc_funcs(void)
#else
PyMODINIT_FUNC PyInit_c_funcs(void); /*proto*/
PyMODINIT_FUNC PyInit_c_funcs(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_c_funcs(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_c_funcs(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("c_funcs", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_gae__cythonized__c_funcs) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gae.cythonized.c_funcs")) {
      if (unlikely(PyDict_SetItemString(modules, "gae.cythonized.c_funcs", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gae.cythonized.c_funcs", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gae.cythonized.c_funcs");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
